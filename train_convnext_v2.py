...
class EarthquakeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image, self.mag_to_idx.get(row['magnitude_class'], 0), self.azi_to_idx.get(row['azimuth_class'], 0)
...
def main():
    print("="*70 + "\nCONVNEXT PRODUCTION TRAINING WITH ON-THE-FLY AUGMENTATION\n" + "="*70)
